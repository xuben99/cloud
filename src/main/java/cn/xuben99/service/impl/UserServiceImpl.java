...
import cn.xuben99.service.UserService;
...
public class UserServiceImpl extends BaseService implements UserService {
   ...
   public boolean update(User user) {
    ...
    @Override
    public User cheakUser(String user_account, String user_password) {
       User user = null;
       user = userMapper.cheakUser(user_account,user_password);
       return user;
    }
