...
public class FtpUtil {
     ...
     * FTP服务器hostname
     */
    private static String HOST = "47.99.147.134";
    /**
     * FTP服务器端口
     */
     ...
     * FTP登录账号
     */
    private static String USERNAME = "ftpuser2";
    /**
     * FTP登录密码
     */
    private static String PASSWORD = "xuben520";
    /**
     * FTP服务器基础目录
     */
    private static String BASEPATH = "/home/ftpuser2";
    /**
     * FTP客户端
     */
    ...
    public static boolean downloadFile( String remotePath,String fileName,String localPath) {
        ...
        try {
            ...
            //ftp.changeWorkingDirectory("1/2020-03-13/0");
            ftp.enterLocalPassiveMode();
